...
//search_2
Route::post('/system/busesschedule', 'managerController@searchbus_2');


//schedule
Route::get('/system/buses/addschedule', 'managerController@addbusschedule')->name('schedule.add');

Route::post('/system/buses/addschedule', 'managerController@addbusscheduleverify')->name('schedule.add');
